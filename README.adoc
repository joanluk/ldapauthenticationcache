...
[![Build Status](https://travis-ci.org/joanluk/ldapauthenticationcache.svg?branch=master)](https://travis-ci.org/joanluk/ldapauthenticationcache)
...
[source,java]
----
include::src/main/java/org/olilab/springldapauthcache/security/ldap/authentication/CachingLdapAuthenticationProvider.java[tags=code]
----